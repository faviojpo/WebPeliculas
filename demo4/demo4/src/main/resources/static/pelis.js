const options = {
  ...
  // Se recomienda trabajar con baseURL como constante en las fetch
const baseURL = 'http://localhost:8080';


  function getPelis() {
//    const respuesta = fetch(`https://api.themoviedb.org/3/movie/top_rated`, options);
    fetch(`${baseURL}/listarPeliculas`, options)
  ...
  //    const respuesta = fetch(`https://api.themoviedb.org/3/movie/top_rated`, options);
      ...
      const respuesta = fetch(`http://localhost:8080/buscarPelis/${tit}`);
  ...
  function renderPelis(response) {
    ...
    for(let peli of peliculas) {
        ...
        <tr>
            ...
            <td>
              <img src="${peli.portada}" alt="" class="img-fluid w-25">
            </td>
            <td>
              <button>
